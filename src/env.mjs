...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_PAY_SECRET: z.string().min(1),
    STRIPE_REFUND_SECRET: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    STRIPE_PAY_SECRET: process.env.STRIPE_PAY_SECRET,
    STRIPE_REFUND_SECRET: process.env.STRIPE_REFUND_SECRET,
